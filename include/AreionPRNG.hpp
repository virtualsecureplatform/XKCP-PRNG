...
struct alignas(64) AreionPRNG{
  static constexpr size_t rate_byte = 32;
  static constexpr size_t state_bits = 512;
  static constexpr size_t state_byte = state_bits/8;
  static constexpr size_t capacity_byte =  state_byte - rate_byte;
  ...
  explicit AreionPRNG(result_type seed_value = 0) { state = {}; state[0] = seed_value;}

  explicit AreionPRNG(std::random_device& seed_gen){
